...
lv_obj_t *streaming_scene_create(lv_fragment_t *self, lv_obj_t *parent) {
    ...
    lv_label_set_text_fmt(hint, locstr("%s"), hints_obtain());
    ...
    lv_obj_add_flag(kbd_btn, LV_OBJ_FLAG_HIDDEN);
    ...
    lv_obj_add_flag(vmouse_btn, LV_OBJ_FLAG_HIDDEN);
    ...
    lv_label_set_text(exit_lbl, locstr("Quit"));
